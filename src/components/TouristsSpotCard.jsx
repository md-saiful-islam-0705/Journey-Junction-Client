...
const TouristsSpotCard = ({ spot }) => {
    const { _id, image, tourists_spot_name, average_cost, totalVisitorsPerYear, travel_time, seasonality } = spot;


    return (
        <div className="card w-91 glass flex flex-col">
        <figure className="flex-grow max-h-[300px] overflow-hidden">
          <img src={image} alt={tourists_spot_name} className="w-full h-64 object-cover" />
        </figure>
